...
const routes: Routes = [
    ...
    { path: "admin", children: [
      { path: "articles/:id/delete", component: ArticleDeleteComponent, resolve: { model: ArticleResolver, user: UserResolver, tag: TagResolver }, canActivate: [ DeleteArticleGuard, AuthGuard] },
      { path: "articles/:id/:mode", component: ArticleEditComponent, resolve: { model: ArticleResolver, user: UserResolver, tag: TagResolver }, canActivate: [ AuthGuard ] },
      { path: "articles/:mode", component: ArticleEditComponent, resolve: { model: ArticleResolver, user: UserResolver, tag: TagResolver }, canActivate: [ AuthGuard ] },
      { path: "articles", component: ArticleListComponent, resolve: { model: ArticleResolver, user: UserResolver, tag: TagResolver }, canActivate: [ AuthGuard ] },
